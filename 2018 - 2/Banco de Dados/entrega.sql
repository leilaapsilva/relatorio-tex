...
--Juliana Karoline de Sousa               594997
...
INSERT INTO disciplina VALUES ('BIO003','BIologgia III',
'Biologia ultra avançada do prof Jubilut.');
INSERT INTO disciplina VALUES ('ECO002','Ecologia II',
'Ecologia nivel hard quem-come-quem complexo');
--INSERT INTO disciplina VALUES ('MAT003','Calculo III',
--'Só integral tripla da derivada da senoide em x dimensões');
INSERT INTO disciplina VALUES ('COMP04','COmputação 4 wtf',
'Eh o inferno em forma de matéria');
...
-- criando procedure: altera a data da atividade, dado o código
CREATE OR REPLACE PROCEDURE atualiza_data_atividade
    (cod IN CHAR,
    data IN DATE)
    IS
...
-- criando procedura: todo mundo que tem presença num curso
-- maior que 95%, ganha 0.5 ponto na nota
CREATE OR REPLACE PROCEDURE nota_extra ()
    IS
    BEGIN
        UPDATE cursa
        SET nota = nota + 0.5
...
INSERT INTO disciplina_pre_req VALUES('COMP02','COMP01');
...
INSERT INTO disciplina_pre_req VALUES('COMP02','MAT001');
INSERT INTO disciplina_pre_req VALUES('BIO003','BIO002');
INSERT INTO disciplina_pre_req VALUES('ECO002','MAT001');
INSERT INTO disciplina_pre_req VALUES('MAT003','MAT002');
INSERT INTO disciplina_pre_req VALUES('COMP04','COMP03');
INSERT INTO disciplina_pre_req VALUES('BIO003','BIO002');



INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000001','MAT001','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000007','COMP01','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000008','BIO002','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000001','ECO001','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000002','MAT001','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000004','BIO002','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000004','COMP01','01','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000003','MAT001','02','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000002','COMP01','02','2018');
INSERT into oferta(num_prof, codigo_disciplina,semestre,ano)  values('000003','BIO002','02','2018');
...
INSERT INTO atividade VALUES ('ATIV04','Trabalho2', 1, DEFAULT,'COMP01');
INSERT INTO atividade VALUES ('ATIV05','Lista 2', 1, TO_DATE('08-12-2018','dd-mm-yyyy'),'COMP01');
INSERT INTO atividade VALUES ('ATIV06','Prova 2', 2, TO_DATE('06-08-2018','dd-mm-yyyy'),'MAT001');
INSERT INTO atividade VALUES ('ATIV07','Trabalho3', 1, DEFAULT,'COMP01');
INSERT INTO atividade VALUES ('ATIV08','Lista 3', 1, TO_DATE('23-12-2018','dd-mm-yyyy'),'COMP01');
INSERT INTO atividade VALUES ('ATIV09','Prova 3', 2, TO_DATE('23-12-2018','dd-mm-yyyy'),'MAT001');
INSERT INTO atividade VALUES ('REC001','Recuperação', 2, TO_DATE('24-12-2018','dd-mm-yyyy'),'COMP01');
...
--2. Selecione os nomes e numero dos professores que oferecem ou ofereceram a disciplina Geometria Analítica, ordenado por semestre.
SELECT p.nome, p.num_prof
    FROM  professor p 
        JOIN oferta o 
        ON p.num_prof = o.num_prof 
            JOIN disciplina d 
            ON o.codigo_disciplina = d.codigo
                WHERE d.nome = 'Geometria Analítica' 
                    ORDER BY o.semestre;

--3: Recupere o nome do professor, seu numero e semestre em que oferta disciplinas, desde que o nome do professor em questão não inclua "Mar"
select p.nome,p.num_prof, o.semestre
from professor p join oferta o on(p.num_prof = o.num_prof)
where p.nome not like '%Mar%'

    
-- [Junção Externa]
--1. todas as disciplinas e seus pre requisitos,caso existam
...
--2.Todas as informações de  ofertas, e o nome de seus professores associados, se houverem
select o.num_prof, o.codigo_disciplina,o.semestre,o.ano
from   professor p right outer join oferta o on p.num_prof = o.num_prof
order by o.num_prof;

--3. Informações de todas as atividades e dos alunos que a fizeram ( se houverem)
select a.codigo, a.nome,a.cod_disciplina, alu.ra
from aluno alu, atividade a left join aluno_faz_atividade afa on a.codigo = afa.codigo_atividade
Order by(a.codigo);
